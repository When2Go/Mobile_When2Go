...
| 지도 | `@mj-studio/react-native-naver-map`의 `NaverMapView` + `NaverMapMarkerOverlay` 직접 사용. Mobile Dynamic Map SDK 한정(과금 API 금지). 상세: `docs/references/naver-maps-api-schema.md` |
