...
// ⚠️ 이 파일은 targets/widget/Attributes.swift 와 구조가 100% 동일해야 한다.
//    ActivityKit 은 타입의 전체 이름 + Codable 구조로 메인 앱(Activity.request)과
//    위젯 익스텐션을 매칭한다. 한쪽만 바꾸면 위젯이 매칭에 실패한다.
